...
AVAILABLE_MODELS = ['densenet121', 'resnet18', 'vgg16', 'wide_resnet50_2', 'resnet50', 'resnet50pt']
...
def create_model(
    ...
    if arch == 'densenet121':
        ...
        raise ValueError(f'Unknown architecture: {arch}. Use canonical names: densenet121, resnet18, vgg16, wide_resnet50_2, resnet50, resnet50pt')
